...
import arduino.*;
import voiceRecognition.StreamingVoiceRecognition;
...
/****************************************  Testing voice recognition *******************************/
		/*ChessController c =ChessController.getInstance();
		c.setGameMode("2player");
		VoiceController v=VoiceController.getInstance();
		Board b=ChessController.getInstance().getBoard();
		b.capture(3, 7, "w");
		b.capture(3, 8, "w");
		b.move(3, 2, 3, 7);
		v.parse("charlie 7 charlie 8 reina");
		v.parse("deshacer deshacer deshacer");
		System.out.println("move-3");
		v.parse("charlie 7 bravo 8 reina");
...
/************************************************* Testing undo and casteling raspPi level ******************/	
		...
		/*ChessController controller=ChessController.getInstance();
